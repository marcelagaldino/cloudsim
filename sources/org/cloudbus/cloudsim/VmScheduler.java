...
public abstract class VmScheduler {
	...
	private double availableMipsInstantiation;

	private double totalHostMips;
	 ...
	 * @post $none
	 */
	public VmScheduler(List<? extends Pe> pelist, int i) {
		setPeList(pelist);
		setPeMap(new HashMap<String, List<Pe>>());
		setMipsMap(new HashMap<String, List<Double>>());
		setAvailableMips(PeList.getTotalMips(getPeList()));
		setHostTotalMips(PeList.getTotalMips(getPeList()));
		setAvailableMipsInstantiation(PeList.getTotalMips(getPeList()));
	...
	public abstract boolean allocatePesForVmInstantiation(Vm vm, List<Double> mipsShare);
	...
	public double getAvailableMipsInstantiation() {
		return availableMipsInstantiation;
	}
	...
	protected void setHostTotalMips(double totalHostMips) { //add to me

		this.totalHostMips = totalHostMips;
	}
	
	public double getHostTotalMips() {
		return totalHostMips;
	}

	
	protected void setAvailableMipsInstantiation(double availableMips) {

		this.availableMipsInstantiation = availableMips;
	}
