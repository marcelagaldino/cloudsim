...
public class PowerVm extends Vm {
	...
	public PowerVm(
			...
			final int priority,
			final String vmm,
			final CloudletSchedulerDynamicWorkload cloudletScheduler,
			final double schedulingInterval,
			final double overcommitment,
			final Map<String, String> vmAffinityMap,
			final Map<String, String> vmAntiAffinityMap,
			final Map<String, ArrayList<String>> preferVmAffinityMap,
			final Map<String, ArrayList<String>> preferVmAntiAffinityMap,
			final SLO slo,
			final ServiceType servicetype,
			final Cloudlet cloudlet){
		super(id, userId, mips, pesNumber, ram, bw, size, priority, vmm, cloudletScheduler, overcommitment,vmAffinityMap,vmAntiAffinityMap,preferVmAffinityMap,preferVmAntiAffinityMap,slo,servicetype, cloudlet);
