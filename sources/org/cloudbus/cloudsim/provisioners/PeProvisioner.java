...
public abstract class PeProvisioner {
	...
	/*public PeProvisioner(double mips, double currentOvercommitment) {
		setMips(mips);
		setAvailableMips(mips);
		setCurrentOvercommitment(currentOvercommitment);
	}

	public void setCurrentOvercommitment(double currentOvercommitment) {
		this.currentOvercommitment = currentOvercommitment;
		
	}
	
	public double getCurrentOvercommitment() {
		return this.currentOvercommitment;
