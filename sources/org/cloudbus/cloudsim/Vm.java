...
public class Vm {
	...
	/** Add by me - contar quantas vezes as vms está requisitando 0 mips */
	private int counter;
	...
	/** Affinity Map */
	private Map<String, String> vmAffinityMap = new HashMap<String, String>();
	
	/** AntiAffinity Map */
	private Map<String, String> vmAntiAffinityMap = new HashMap<String, String>();
	
	/** Prefer Affinity Map */
	private Map<String, ArrayList<String>> preferVmAffinityMap = new HashMap<String, ArrayList<String>>();
	
	/** Prefer AntiAffinity Map */
	private Map<String, ArrayList<String>> preferVmAntiAffinityMap = new HashMap<String, ArrayList<String>>();
	...
	public Vm(
			...
			int priority,
			String vmm,
			CloudletSchedulerDynamicWorkload cloudletScheduler,
			double Overcommitment,
			Map<String, String> vmAffinityMap,
			Map<String, String> vmAntiAffinityMap,
			Map<String, ArrayList<String>> preferVmAffinityMap,
			Map<String, ArrayList<String>> preferVmAntiAffinityMap,
			SLO slo,
		...
		setVmAffinityMap(vmAffinityMap);
		setVmAntiAffinityMap(vmAntiAffinityMap);
		
		setPreferVmAffinityMap(preferVmAffinityMap);
		setPreferVmAntiAffinityMap(preferVmAntiAffinityMap);
	...
	private void setCloudlet(Cloudlet cloudlet) {
	...
	private void setPreferVmAntiAffinityMap(Map<String, ArrayList<String>> preferVmAntiAffinityMap) {
		this.preferVmAntiAffinityMap = preferVmAntiAffinityMap;
		
	}



	private void setPreferVmAffinityMap(Map<String, ArrayList<String>> preferVmAffinityMap) {
		this.preferVmAffinityMap = preferVmAffinityMap;
		
	}
	
	public Map<String, ArrayList<String>> getPreferVmAntiAffinityMap() {
		return preferVmAntiAffinityMap;
		
	}



	public Map<String, ArrayList<String>> getPreferVmAffinityMap() {
		return preferVmAffinityMap;
		
	}



	private void setVmAffinityMap(Map<String, String> vmAffinityMap) {
		this.vmAffinityMap = vmAffinityMap;
		
	}
	
	private void setVmAntiAffinityMap(Map<String, String> vmAntiAffinityMap) {
		this.vmAntiAffinityMap = vmAntiAffinityMap;
		
	}
	
	public Map<String, String> getVmAffinityMap() {
		return vmAffinityMap;
		
	}
	
	public Map<String, String> getVmAntiAffinityMap() {
		return vmAntiAffinityMap;
	 ...
	 */
	public CloudletSchedulerDynamicWorkload getCloudletScheduler() {
	 ...
	 */
	protected void setCloudletScheduler(CloudletSchedulerDynamicWorkload cloudletScheduler) {
