...
public abstract class RunnerAbstract {
	...
	protected static List<Cloudlet> cloudletList2;

	/** The vm list. */
	protected static List<Vm> vmList;
	protected static List<Vm> vmList2;
	...
	public RunnerAbstract(
		...
		init(inputFolder + "/" + workload, filePriority, fileError, expName);
		start(
	 ...
	 * @param inputFolder the input folder
	 */
	protected abstract void init(String inputFolder, String filePriority, String fileError, String expName);
	 ...
	 * @param vmAllocationPolicy the vm allocation policy
	 */
	protected void start(String experimentName, String outputFolder, VmAllocationPolicy vmAllocationPolicy, String fileInitVm) {
		...
		try {
			...
			double lastClock = CloudSim.startSimulation(fileInitVm);
